...
//     // Check token from store directly
//     const currentToken = useAuthStore.getState().token;
//     console.log('[Chat] token check:', currentToken ? 'present' : 'NULL');

//     if (!currentToken) {
//       setMessages((prev) => [...prev, {
//         id: Date.now().toString(),
//         role: "assistant",
//         content: "Session expired. Please log out and log back in.",
//         timestamp: Date.now(),
//       }]);
//       return;
//     }
...
//         id: (Date.now() + 1).toString(),
//         role: "assistant",
//         content: err?.message?.includes('Unauthorized')
