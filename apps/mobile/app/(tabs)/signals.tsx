...
//   // Reset unread badge when this tab is focused
//   useCallback(() => { markAllRead(); }, [markAllRead])();

//   const filtered = signals.filter((s) => {
//     if (activeFilter === "BUY")  return s.type === "BUY";
//     if (activeFilter === "SELL") return s.type === "SELL";
//     if (activeFilter === "high") return s.confidence_score >= 80;
//     return true;
//   });
