...
// ─────────────────────────────────────────────
// CHAT HISTORY
// Table: chat_messages (NOT chat_history)
// ─────────────────────────────────────────────
...
export async function saveChatMessage(
  ...
  if (error) {
    // Non-fatal: log but don't crash the chat endpoint
    console.error(`[DB] saveChatMessage failed: ${error.message}`);
  }
}
...
export async function getChatHistory(
  ...
  if (error) {
    console.error(`[DB] getChatHistory failed: ${error.message}`);
    return [];
  }
