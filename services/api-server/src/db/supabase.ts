...
// // ─────────────────────────────────────────────
// // Supabase client — service role (server only, NEVER expose to client)
// // ─────────────────────────────────────────────
...
// // ─────────────────────────────────────────────
// // CHAT HISTORY
// // ✅ FIX: was querying 'chat_history' — correct table is 'chat_messages'
// // ─────────────────────────────────────────────
...
//   message: ChatMessage
// ): Promise<void> {
//   const { error } = await supabase.from('chat_messages').insert({  // ✅ fixed table name
//     user_id: userId,
//     role:    message.role,
...
// ): Promise<ChatMessage[]> {
//   const { data, error } = await supabase
//     .from('chat_messages')                                          // ✅ fixed table name
